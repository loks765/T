...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    if (/webp/g.test(mime)) {
      ...
      throw `*الاستجابة لصورة أو فيديو أو GIF ${usedPrefix + command}*`
    }
  } catch {
    stiker = `قم بالأشارة على الصورة بأستخدام 
...
handler.help = ['sfull','ملصق']
handler.tags = ['sticker']
handler.command = ['ستيكر','ملصق', 's','م', 'sticker', 'gif']
