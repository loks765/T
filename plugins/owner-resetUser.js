 ...
 // if(number.length > 8) return conn.reply(m.chat, `*❏ USER RESET*\n\nThe number you entered is invalid!`, m)
  ...
  let participants = m.isGroup ? groupMetadata.participants : []
	...
	delete global.global.db.data.users[user]
 	...
 	conn.reply(m.chat, `> *˼❏˹ إعـادة تـعيـيـن المـستـخـدم╿↶*\n*╮──────────────────⟢ـ*\n*┇ تــم إعـادة تـعيـيـن إلــى*\n*┇ @${number}*\n*┇ مــن قــاعــدة الــبــيــانــات*\n*╯──────────────────⟢ـ*`, null, { mentions: [user] })
...
handler.tags = ['owner']
handler.command = ['ريست','ريسيت-يوزر','رست','ريسيت','reset'] 
handler.admin = false
handler.rowner = true
