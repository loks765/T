...
//afk-_afk.js
const smsAfkM1 = () => { return `${lenguajeGB['smsAvisoEG']()}*منور لقد عدت من الاختفاء*`} 
const smsAfkM2 = () => { return `*السبب:*`} 
const smsAfkM3 = () => { return `*مده الاختفاء:*`} 
const smsAfkM4 = () => { return `${lenguajeGB['smsAvisoAG']()}*لا تمنشن عليه لانه في وضع الاختفاء الان*`} 
const smsAfkM5 = () => { return `*السبب:*`} 
const smsAfkM6 = () => { return `*السبب: بدون سبب*`} 

//afk-afk.js
const smsAfkM1A = () => { return `${lenguajeGB['smsAvisoAG']()}*لا تمنشن علي`} 
