...
const smsGrupoTime2 = () => { return '🔒 *_مجموعة مغلقة لساعة واحدة_*'}
...
const smsGrupoTime7 = () => { return '🔒 *تم تحديد تاريخ المجموعة ، يمكن للمديرين فقط إرسال الرسائل*'}
const smsGrupoTime8 = () => { return '🔓 *المجموعة مفتوحة ،انتشرو*'}
const smsGrupoTime9 = () => { return '🔓 مجموعة مفتوحة أثناء '}
const smsGrupoTime10 = () => { return '🔒 مجموعة مغلقة اثناء '}
const smsGrupoTime11 = () => { return ' ساعة'}
const smsGrupoTime12 = () => { return 'السماح للمجموعة بالمرور '}
const smsGrupoTime13 = () => { return 'السماح أو المجموعة للغلق'}
...
const smsCont18Porn = () => { return `🔞 محتوى* 🔞`} //texto
const smsCont18Porn2 = () => { return `🔞 محتوى 🔞`} //texto
const smsCont18PornP = () => { return `🌟 *محتوى ❤️‍🔥 جائزة* 🌟`} //texto
const smsCont18PornP2 = () => { return `محتوى ❤️‍🔥 جائزة`} //texto  

//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeGB['smsAvisoMG']()}*ضع علامة على أحد الأشخاص أو رد على رسالة المستخدم أو اكتب الرقم الذي تريد حظره من الأوامر*\n\n*مثال:*\n*مثال ${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${lenguajeGB['smsAvisoFG']()}*@${bot} لا يمكن حظره بهذا الأمر* 😹`}
const smsPropban3 = (ownerNumber) => { return `${lenguajeGB.smsAvisoIIG()}😳 *لا يمكنني منع المالك@${ownerNumber} DE ${packname}*`}
