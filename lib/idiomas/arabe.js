...
const smsAvisoIIG = () => { return `↜معلومه↝\n\n` }
const smsAvisoFG = () => { return `↜خطأ↝\n\n` }
const smsAvisoMG = () => { return `↜عمل سئ↝\n\n` }
const smsAvisoEEG = () => { return `↜بلغ عن↝\n\n` }
const smsAvisoEG = () => { return `↜نجح↝\n\n` }
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز ShadowBot-MD - WhatsApp '}
...
//متجر
//Tienda
const eExp = () => { return '⚡  شادو اكس بي' } 
const eDiamante = () => { return '💎 الماس' } 
const eDiamantePlus = () => { return '💎+ الماس+' }
const eToken = () => { return '🪙 عملات شادو' } 
const eEsmeralda = () => { return '💚 زمرد' } 
const eJoya = () => { return '♦️ جوهرة' }
const eMagia = () => { return '🌀 سحر - استغفر الله- هزار طبعا' } 
const eOro = () => { return '👑 ذهب' } 
const eGataCoins = () => { return '🐱 شادو كوينز' }
const eGataTickers = () => { return '🎫 اسهم شادو' } 
const eEnergia = () => { return '✨ طاقة' }
const ePocion = () => { return '🥤 جرعة' }
const eAgua = () => { return '💧 ماء' }
const eBasura = () => { return '🗑 زبالة' }
const eMadera = () => { return '🪵 خشب' }
const eRoca = () => { return '🪨 صخر' }
const ePiedra = () => { return '🥌 حجر' }
const eCuerda = () => { return '🕸️ حبل' }
const eHierro = () => { return '⛓️ حديد' }
const eCarbon = () => { return '⚱️ فحم' }
const eBotella = () => { return '🍶 زجاجة' }
const eLata = () => { return '🥫 شادو كولا' }
const eCarton = () => { return '🪧 ورق مقوى' } 
const eEletric = () => { return '💡 كهرباء' }
const eBarraOro = () => { return '〽️ سبيكة ذهب' }
const eOroComun = () => { return '🧭 سرعة شادو' }
const eZorroG = () => { return '🦊🌫️ سوبر فوكس' }
const eBasuraG = () => { return '🗑🌫️ قمامة فائقة' }
const eLoboG = () => { return '🐺🌫️ سوبر وولف' }
const eMaderaG = () => { return '🛷🌫️ سوبر وود' }
const eEspada = () => { return '⚔️ سيف' }
const eCarnada = () => { return '🪱 طعم' }
const eBillete = () => { return '💵 الأوراق النقدية' }
const ePinata = () => { return '🪅 بينياتا' }
const eGancho = () => { return '🪝 خطاف' }
const eCanaPescar = () => { return '🎣 عصا' } 
const eCComun = () => { return '📦 الصندوق المشترك' }
const ePComun = () => { return '🥡 صندوق غير شائع' }
const eCMistica = () => { return '🗳️ صندوق أسطوري' }
const eCMascota = () => { return '📫 صندوق الحيوانات الأليفة' }
const eCJardineria = () => { return '💐 صندوق البستنة' }
const eClegendaria = () => { return '🎁 الصندوق الأسطوري' } 
const eUva = () => { return '🍇 عنب' }
const eManzana = () => { return '🍎 تفاحة' }
const eNaranja = () => { return '🍊 البرتقالي' }
const eMango = () => { return '🥭 مانجو' }
const ePlatano = () => { return '🍌 موز' } 
const eSUva = () => { return '🌾🍇 بذور العنب' }
const eSManzana = () => { return '🌾🍎 بذور التفاح' }
const eSNaranja = () => { return '🌾🍊 بذور البرتقال' }
const eSMango = () => { return '🌾🥭 بذور المانجو' }
const eSPlatano = () => { return '🌾🍌 بذور الموز' } 
const eCentauro = () => { return '🐐 القنطور' }
const eAve = () => { return '🦅 طائر' }
const eGato = () => { return '🐈 قطة' }
const eDragon = () => { return '🐉 التنين' }
const eZorro = () => { return '🦊 فوكس' }
const eCaballo = () => { return '🐎 حصان' }
const eFenix = () => { return '🕊️ فينيكس' }
const eLobo = () => { return '🐺 ذئب' }
const ePerro = () => { return '🐶 كلب' } 
const eAMascots = () => { return '🍖 طعام الحيوانات الاليفة' }
const eCCentauro = () => { return '🐐🥩 طعام القنطور' }
const eCAve = () => { return '🦅🥩 الغذاء الطيور' }
const eCMagica = () => { return '🌀🥩 ماجيك فود' }
const eCDragon = () => { return '🐉🥩 طعام التنين' }
const eACaballo = () => { return '🐎🥩 طعام الحصان' }
const eCFenix = () => { return '🕊️🥩 طعام الفينيق' } 
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام شادو بوت`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام شادو بوت في المجموعات`}
...
const smsAntiE2 = () => { return `احذف الأشخاص الذين يرسلون روابط من مجموعات واتس اب`}
...
const smsAntiTT2 = () => { return `إزالة الأشخاص الذين يرسلون روابط تسك توك`}
const smsAntiYT1 = () => { return `🔗 يوتيوب ممنوع`}
const smsAntiYT2 = () => { return `إزالة الأشخاص الذين يرسلون روابط يوتيوب`}
const smsAntiTEL1 = () => { return `🔗 أنتي تليغرام`}
const smsAntiTEL2 = () => { return `إزالة الأشخاص الذين يرسلون روابط تليجرام`}
const smsAntiFB1 = () => { return `🔗 الفيسبوك محظور`}
const smsAntiFB2 = () => { return `قم بإزالة الأشخاص الذين يرسلون روابط فيس بوك`}
const smsAntiIG1 = () => { return `🔗 مضاد إنستغرام`}
const smsAntiIG2 = () => { return `قم بإزالة الأشخاص الذين يرسلون روابط انستغرام`}
const smsAntiTW1 = () => { return `🔗 مضاد للتويتر `}
const smsAntiTW2 = () => { return `إزالة الأشخاص الذين يرسلون روابط تويتر`}
...
//afk-_afk.js
const smsAfkM1 = () => { return `${lenguajeGB['smsAvisoEG']()}*انه في وضع الاختفاء الان*`} 
const smsAfkM2 = () => { return `*السبب:*`} 
const smsAfkM3 = () => { return `*مده الاختفاء:*`} 
const smsAfkM4 = () => { return `${lenguajeGB['smsAvisoAG']()}*لا تمنشن عليه انه في وضع الاختفاء الان*`} 
const smsAfkM5 = () => { return `*السبب:*`} 
const smsAfkM6 = () => { return `*السبب: بدون سبب*`} 

//afk-afk.js
const smsAfkM1A = () => { return `${lenguajeGB['smsAvisoAG']()}*لا تمنشن عليه`} 
const smsAfkM1B = () => { return `*انه في وضع الاختفاء الان*\n\n*السبب*`} 
...
const smsTex17 = () => { return '*ليس من الضروري استخدام البادئة في الاصوات*'}
...
const smsTex23 = () => { return '*ميمز العشوائية وقائمة الرسوم المتحركة*'}
